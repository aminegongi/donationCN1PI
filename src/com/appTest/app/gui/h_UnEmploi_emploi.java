 ...
 * @author Hechem
 */
public class h_UnEmploi_emploi extends SideMenuNov {

    Form current;
    EncodedImage placeholder;
    Button eng =new Button("Anglais");

    public h_UnEmploi_emploi(Emploi emp) {
        ...
        eng.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                new h_UnEmploi_eng_emploi(emp).show();
            }
        });
        current.add(eng);
        ...
        pdf.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ServiceEmploi.getInstance().pdfEmploi(emp);
            }
        });
        shareBox.add(pdf);
        ...
        SpanLabel salaire = new SpanLabel("Salaire : " + Float.toString(emp.getSalaire()));
        SpanLabel emplacement = new SpanLabel("Emplacement : " + emp.getEmplacement());
        SpanLabel catego = new SpanLabel("Catégorie  : " + emp.getCategorie());
        SpanLabel tEmploi = new SpanLabel("Type Emploi : " + emp.getType_emploi());
        SpanLabel tContrat = new SpanLabel("Type Contrat : " + emp.getType_contrat());
        SpanLabel user = new SpanLabel("Déposer par : " + emp.getUser().getUsername());
