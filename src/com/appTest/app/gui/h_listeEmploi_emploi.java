 ...
 * @author Hechem
 */
public class h_listeEmploi_emploi extends SideMenuNov {

    Form current;
    EncodedImage placeholder;

    public h_listeEmploi_emploi() {
        addSideMenu();
        getToolbar().setUIID("aide_Toolbar");

        current = this;
        current.setTitle("Les Emplois");
        ...
        ArrayList<Emploi> emploi = ServiceEmploi.getInstance().getAllEmplois();
